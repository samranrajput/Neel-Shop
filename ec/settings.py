...
SECRET_KEY = 'django-insecure-ohp$sf%25$n4@&_l@!n3)-r@(oh7t9po=0e6ug)&$#qgr!87@b'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'samranrajput791@gmail.com'
EMAIL_HOST_PASSWORD = 'vyvw fyer mjsl ulbv'
...
LOGIN_URL = 'login'  # ya aapka custom login path
